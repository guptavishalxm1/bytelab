...
export const COMPANY_DATA = {
  ...
  legalName: "ByteLab Infotech",
  shortName: "ByteLab",
  tagline: "Engineering Digital Products That Actually Work",
  subHeadline: "Technology Built Around Your Business",
  description:
    "ByteLab Infotech is a technology services and software engineering organization. We architect and build dependable web applications, mobile apps, Java/Spring Boot backend systems, databases, and business automation workflows designed around real operational requirements.",
  domain: "bytelabinfotech.in",
  officialUrl: "https://bytelabinfotech.in",
  primaryEmail: "contact@bytelabinfotech.in",
  supportEmail: "support@bytelabinfotech.in",
  phone: "+91 98765 43210", // Formatted business phone
  operatingHours: "Monday – Friday: 09:30 AM – 06:30 PM IST",
  establishedYear: 2024,
  headquarters: {
    city: "India",
    country: "India",
    address: "Registered Technology Enterprise, India",
  },
  positioning: {
  ...
  credentials: [
    {
      id: "domain",
      type: "Official Domain",
      label: "Registered Web Identity",
      value: "bytelabinfotech.in",
      identifier: "bytelabinfotech.in",
      description: "Official, verified corporate domain and communication host.",
      verified: true,
    ...
    },
    {
      ...
      value: "Available on Verification",
      identifier: "GSTIN Registered Enterprise",
      description: "Formally registered under the Goods and Services Tax framework for compliant business invoicing.",
      verified: true,
      status: "Compliant Enterprise",
      category: "tax",
    },
    {
      id: "udyam",
  ...
  leadership: [
    {
      ...
      role: "Technical Founder & Lead Systems Architect",
      ...
      links: {
        ...
        email: "contact@bytelabinfotech.in",
      },
    },
  ] as LeadershipMember[],
  coreTenets: [
